...
export const TOP_ORGANISMS: readonly TopOrganism[] = [
  ...
  { name: 'Klebsiella pneumoniae',   arCode: 'CRE',  detectionCount: 1301, siteCount: 11, yoyTrend: 'up',     resistanceRate: 31.4 },
  { name: 'Acinetobacter baumannii', arCode: 'MDRO', detectionCount: 984,  siteCount: 9,  yoyTrend: 'stable', resistanceRate: 26.1 },
  { name: 'Pseudomonas aeruginosa',  arCode: 'MDR',  detectionCount: 674,  siteCount: 8,  yoyTrend: 'down',   resistanceRate: 17.8 },
  { name: 'Enterococcus faecium',    arCode: 'VRE',  detectionCount: 413,  siteCount: 6,  yoyTrend: 'stable', resistanceRate: 11.2 },
]
